...
function getHeardList($logLines) {
	...
	$dttxend = "";
	foreach ($logLines as $logLine) {
		if (strpos($logLine,"Data from") == false and strpos($logLine,"blocked") == false and strpos($logLine,"Reload the Blacklist from File") == false and strpos($logLine,"Reload the Blacklist from File") == false and strpos($logLine,"YSF server status enquiry from") == false) {
